...
const PHENO_COLORS = ["#8ee0a8", "#e6bd73", "#7fb2f0", "#ef8fb0"];
...
function GameteSummary({ title, gametes }: { title: string; gametes: Gamete[] }) {
  return (
...
function PunnettBoard({
  result,
  traits,
  selected,
  onSelect
}: {
  result: ReturnType<typeof runCross>;
  traits: TraitDefinition[];
